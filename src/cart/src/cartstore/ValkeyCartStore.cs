...
public class ValkeyCartStore : ICartStore
{
    ...
    private static readonly ActivitySource CartActivitySource = new("Northstar.Commerce.Cart");
    private static readonly Meter CartMeter = new Meter("Northstar.Commerce.Cart");
